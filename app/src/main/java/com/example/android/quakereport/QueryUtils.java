...
public final class QueryUtils {
    ...
    public static List<quakeInfo> fetchEarthquakeData(String requestUrl) {
        ...
        List<quakeInfo> earthquakes = extractFeatureFromJson(jsonResponse);
    ...
    /**
     * Return an {@link quakeInfo} object by parsing out information
     * about the first earthquake from the input earthquakeJSON string.
     */
    private static List<quakeInfo> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            //Iterate the jsonArray and compile key earthquake info
            for (int i = 0; i < features.length(); i++) {
                ...
                earthquakes.add(new quakeInfo(mag, place, timeInMilliseconds, url));
            }
